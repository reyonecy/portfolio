          ...
          <FadeIn delay={0.1}>
            <div className="prose prose-lg text-text-secondary space-y-6">
              ...
              <p>
                ...
                interactive visualizations, or developing full-stack applications,
                I find joy in every layer of the process.
              </p>

              <p>
                What drives me is the belief that technology should serve people.
                I'm constantly learning, experimenting, and pushing myself to understand
                new concepts. From deep learning architectures to elegant web interfaces,
                I approach each project as an opportunity to create something meaningful.
              </p>

              <p>
                Beyond the screen, you'll find me exploring new technologies,
